...
import 'package:frontend/features/all_prescriptions/data/get_all_prescriptions.dart';
import 'package:frontend/features/single_prescription/presentation/single_prescription.dart';
...
class _AllPrescriptionsPageState extends State<AllPrescriptionsPage> {
  ...
  Widget build(BuildContext context) {
    GetPrescriptionAppointments _getAppointments =
        new GetPrescriptionAppointments();
    final Future<List<dynamic>> _response = _getAppointments.getData();
    return Scaffold(
        appBar: AppBar(
